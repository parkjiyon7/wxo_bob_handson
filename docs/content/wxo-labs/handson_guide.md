...
7. 본인이 생성한 **ABC Robots Agent-<본인이름>**, **Comp Analysis Agent-<본인이름>**, **Identifier Agent-<본인이름>**를 선택한 다음 **Add to Agent** 버튼을 클릭합니다.
...
2. 드롭다운 메뉴에서 본인이 생성한 **Master Agent-<본인이름>**를 선택하면 준비가 완료됩니다.
...
1. 좌측 상단의 햄버거 메뉴(☰)를 클릭하고 **Build**를 선택한 다음 본인이 생성한 **Master Agent-<본인이름>**를 선택합니다.
